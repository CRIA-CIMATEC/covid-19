...
@Component({
    selector: 'plotly-value-recovery',
    templateUrl: './plotly_value_recovery.component.html'
})

export class PlotlyValueRecoveryComponent implements OnInit {
  school: any;
  public: any;
  domestic: any;
  transport: any;
  ...
  work: any;
    ...
    ngOnInit(){
      CenarioService.ResponseHigh_economy_value.subscribe(
 ...
 this.setAll(CancellationOfPublicEvents, Public_Closures, Restriction_Movement, Restriction_Size, Restriction_Travel, School_Closure,Stay_Requirements, Workplace_Closure)
  ...
  // console.log()
    ...
    getDashboard(obj?) {
      ...
      this.ShowMessage = CenarioService._showMessage;
