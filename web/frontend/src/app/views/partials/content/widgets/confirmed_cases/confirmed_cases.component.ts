...
@Component({
	selector: 'kt-confirmed_cases',
	templateUrl: './confirmed_cases.component.html',
	styleUrls: ['./confirmed_cases.component.scss']
})
				...
				datasets: [
					{
						...
						borderColor: color(this.layoutConfigService.getConfig('colors.state.brand')).alpha(1).rgbString(),
