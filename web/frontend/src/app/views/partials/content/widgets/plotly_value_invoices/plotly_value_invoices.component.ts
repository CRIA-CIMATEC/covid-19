...
@Component({
    selector: 'plotly-invoices-value',
    templateUrl: './plotly_value_invoices.component.html'
})

export class PlotlyValueInvoicesComponent implements OnInit {
  ...
  constructor(
    ...
    ngOnInit(){
      ...
      //   a => this.responseDashboard(a)
	    // )
	    // CenarioService._emitedhigh_economy.subscribe(
      //   b => this.response2Dashboard(b)
	    // )
	    // CenarioService._emitedmoderate.subscribe(
      //   c => this.response2Dashboard(c)
      // )
      // CenarioService.CountryResponse.subscribe(
      //   z => this.responseDashboard(z)
      // )
      //this.dashboardService.
      // this.ShowMessagevalue = DashboardService._showMessage;
      // console.log(this.ShowMessagevalue)
    }

    getDashboard(obj?) {
     this.ShowMessage = DashboardService._showMessage;
      // console.log(this.ShowMessage)

      let obj1 = obj['NFC-e'].Valor;
      // console.log(obj1);
    ...
    responseDashboard(resp :any): void{
      this.ShowMessage = SimulationService._showMessage;
      console.log("response dashboard")
      //console.log(resp.body.Notas['NFC-e'])
      let obj = resp.Notas['NFC-e'].Valor;
      ...
      var quantidade_real = obj.real.valor;
      var quantidade_IA = Array(realLength)
                          .fill(null).concat(obj.IA.valor)
      //var quantidade_SIRD = Array(realLength-1)
      //                      .fill(null).concat(obj.SIRD.quantidade)
