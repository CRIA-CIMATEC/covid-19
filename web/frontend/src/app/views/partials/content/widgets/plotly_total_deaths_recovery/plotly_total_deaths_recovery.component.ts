...
@Component({
    selector: 'plotly-total-deaths-recovery',
    templateUrl: './plotly_total_deaths_recovery.component.html'
})

export class PlotlyTotalDeathsRecoveryComponent implements OnInit {
