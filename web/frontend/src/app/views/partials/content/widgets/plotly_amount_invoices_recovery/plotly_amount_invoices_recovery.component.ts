...
@Component({
    selector: 'plotly-amount-invoices-recovery',
    templateUrl: './plotly_amount_invoices_recovery.component.html'
})
export class PlotlyAmountInvoicesRecoveryComponent implements OnInit {
    teste: any;
  school: any;
  public: any;
  domestic: any;
  ...
  work: any;
    ...
    getDashboard(obj?) {
    this.ShowMessageamount1 = CenarioService._showMessage;
