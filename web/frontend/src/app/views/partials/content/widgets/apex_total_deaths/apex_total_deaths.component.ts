...
export type ChartOptions = {
  ...
  @Component({
	selector: 'apex_total_deaths',
	templateUrl: './apex_total_deaths.component.html',
	styleUrls: ['./apex_total_deaths.component.scss']
})

export class ApexTotalDeathsComponent implements OnInit {
