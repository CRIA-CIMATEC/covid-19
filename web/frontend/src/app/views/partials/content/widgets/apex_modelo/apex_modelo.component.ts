...
export type ChartOptions = {
  ...
  @Component({
	selector: 'apex_modelo',
	templateUrl: './apex_modelo.component.html',
	styleUrls: ['./apex_modelo.component.scss']
})

export class ApexModeloComponent implements OnInit {
    ...
    //   getdashboard() {
    //     this.dashboardService.getConfirmados().subscribe(obj => {
