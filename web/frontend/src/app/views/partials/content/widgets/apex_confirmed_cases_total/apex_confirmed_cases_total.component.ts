...
import { UserData } from '../simulation_top/simulation_top.component';
...
export type ChartOptions = {
  ...
  @Component({
	selector: 'apex_confirmed_cases_total',
	templateUrl: './apex_confirmed_cases_total.component.html',
	styleUrls: ['./apex_confirmed_cases_total.component.scss']
})

export class ApexConfirmedTotalComponent implements OnInit {
    ...
    apexChart: any;
    userInput: UserData;
    // base_url = 'https://covid19.fieb.org.br:9050/api/simulation/';
    ...
    responseDashboard(cases :any): void{
      let obj = cases.Confirmed.Amount;
      //console.log(obj);
