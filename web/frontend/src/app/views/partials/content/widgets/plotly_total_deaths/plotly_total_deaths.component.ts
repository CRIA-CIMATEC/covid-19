...
@Component({
    selector: 'plotly-total-deaths',
    templateUrl: './plotly_total_deaths.component.html'
})

export class PlotlyTotalDeathsComponent {
...
_sirdLowerError;
_sirdUpperError;
_sirdMeasurement: { x: any; y: any; fill: string; fillcolor: string; line: { color: string; }; mode: string; name: string; type: string; };
_realTrace: { x: any; y: any; line: { color: string; }; mode: string; name: string; type: string; };
_iaMeasurement: any;
...
ngOnInit(){
  ...
  DashboardService.CountryResponse4.subscribe(
...
// };
  ...
  //     data: [this._realTrace, this._iaLowerError, this._iaMeasurement, this._iaUpperError, this._sirdLowerError, this._sirdMeasurement, this._sirdUpperError],
  //     layout: this.layout
  //   }
